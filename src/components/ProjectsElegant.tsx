...
const projectsData = [
  {
    ...
    links: {
      github: "https://github.com/razan-aboushi/Edu_Spark",
    },
    icon: Globe,
    featured: true,
  },
  ...
  {
    title: "YouBelong Platform",
    type: "Full Stack Application",
    description: "A comprehensive web platform built using Laravel framework following MVC architecture pattern with MySQL database integration.",
    technologies: ["PHP 8", "Laravel Framework 9", "MySQL 5.7", "HTML", "CSS", "Bootstrap", "Apache Server", "Composer"],
    links: {
      github: "https://github.com/razan-aboushi/youbelong",
    },
    icon: Globe,
    featured: true,
  },
  ...
  {
    title: "Mockup and Wireframe",
    type: "Design Project",
    description: "Created initial website wireframes and mockup screens using Figma for UI/UX design planning and prototyping.",
    technologies: ["Figma", "Wireframing", "UI Design", "Prototyping"],
    links: {
      github: "https://github.com/razan-aboushi/mockup-and-wireframe",
    },
    icon: Globe,
  },
];
